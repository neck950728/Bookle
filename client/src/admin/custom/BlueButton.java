...
public class BlueButton extends JButton {
	...
	private BlueButton self = this;
	private Dimension dimension = new Dimension(getPreferredSize().width, getPreferredSize().height);

	private ImageIcon imageIconNormal = search.Main.getScaledImageIcon("BlueButtonNormal.png");
	private ImageIcon imageIconFocused = search.Main.getScaledImageIcon("BlueButtonFocused.png");
	private ImageIcon imageIconPressed = search.Main.getScaledImageIcon("BlueButtonPressed.png");
